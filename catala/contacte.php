...
if(isset($_POST["phpmailer"])) {
	...
	if($mail->send()) {
		$msg = "<div class='alert alert-success' style='text-align:center;'><h3>Perfecte!!</h3><p> El correu enviat des de <b>$email</b>, s'ha rebut correctament. <br/> $nombre, em posare en contacte amb vosté abans de 2 dies hàbils.</p></div>";
	} else {
		$msg = "<div class='alert alert-danger' style='text-align:center;'><h3>¡¡ATENCIÓ!!</h3><p> $nombre hi ha  hagut el seguent error al enviar el correu: <br/> <b>$mail->ErrorInfo;</b><br/> Revisa els camps o intenta-ho de nou més tard. <br/> Disculpi les molesties.</p></div>";
	}
} else {
		$msg = "<div class='alert alert-danger' style='text-align:center;'><h3>¡¡ATENCIÓ!!</h3><p>Ha de verificar el captcha.</p> </div>";
	}
}
...
<!DOCTYPE html>
<html lang="ca"><!-- InstanceBegin template="/Templates/catala.dwt" codeOutsideHTMLIsLocked="false" -->
  <head>
    <meta charset="utf-8">
	...
	<meta name="description" content="Pàgina web d'un dissenyador gràfic, dissenyador web, progrmador web i expert en e-commerce">
	...
	<meta name="robots" content="disseny gràfic, disseny web, programació web, e-commerce" />
	<meta name="http-equiv" content="X-Robots-Tag : noindex, follow" />
	<meta name="googlebot" content="disseny gràfic, disseny web, programació web, e-commerce" />	
	...
	<meta property="og:description" content="Pàgina curriculum"/>
	...
	<meta name="twitter:description" content="Pàgina curriculum, disseny gràfic, disseny web, programació web, e-commerce" />
	<!-- URL of image to use in the card. Used with summary, summary_large_image, player cards -->
	<meta name="twitter:image" content="" />
	 
	<!-- InstanceBeginEditable name="Titulo" -->
    <title>jmmcDesign - Contacte</title>  
	<!-- InstanceEndEditable -->
	...
	<div class="container">
		<nav id="navigation"><img src="../img/LOGO_blue.png" alt="Logo" title="Logo" width="115px"> <a aria-label="mobile menu" class="nav-toggle"> <span></span> <span></span> <span></span> </a>
      		<ul class="menu-left">
				...
				<li><a href="eines.html">Les meves eines</a></li>
        		<li><a href="qui.html">Qui sóc?</a></li>
        		<li><a href="estudis.html">Estudis</a></li>
        		<li><a href="treballs.html">Experiència</a></li>
				<li><a href="#" id="dropdownMenu1" data-toggle="dropdown">Dossier</a>
				<ul class="dropdown-menu pull-right" role="menu" aria-labelledby="dropdownMenu1">
    				<li role="presentation">
      					<a role="menuitem" tabindex="-1" href="dossier_cartelleria.html">Cartelleria</a>
    				</li>
					
    				<li role="presentation">
      					<a role="menuitem" tabindex="-1" href="dossier_logo.html">Logotip</a>
    				</li>
					
    				<li role="presentation">
      					<a role="menuitem" tabindex="-1" href="dossier_papeleria.html">Papereria</a>
    				</li>
					
					<li role="presentation">
      					<a role="menuitem" tabindex="-1" href="dossier_publi.html">Publicitat</a>
    				</li>
					
					<li role="presentation">
      					<a role="menuitem" tabindex="-1" href="dossier_restaurant.html">Carta de Restaurant</a>
    				</li>
					
					<li role="presentation">
      					<a role="menuitem" tabindex="-1" href="dossier_web.html">Web</a>
    				</li>
  				</ul>
				...
				<li><a href="index.html"><img src="../img/catalan_flag.png" alt="Català" title="Català" width="25px"></a></li>
				<!-- InstanceEndEditable -->
				<br/>
      		</ul>
    	</nav>
	...
	<section>
		<div class="container">
			<div class="col-lg-12">
				<div class="row">
					<div class="subtitulo">
						<h1>Si desitja que treballi per a la seva empresa o desitja algun dels meus serveis, es pot posar en contacte amb mi.<br/>
					<span id="frase-contacto">Estic segur que junts podem arribar a fer coses impressionants</span></h1>
					</div>
				</div>	
			</div>
		</div>
        ...
        <div class="col-lg-8">
            <div class="well well-sm">
				...
				action="<?=$_SERVER['PHP_SELF']?>" >
                    <fieldset>
                        <legend class="text-center header">Què desitja?</legend>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input id="fname" name="nombre" type="text" placeholder="El seu nom" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input id="lname" name="empresa" type="text" placeholder="Nom de la seva empresa" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input id="email" name="email" type="text" placeholder="Correu electrònic" class="form-control" required >
                            </div>
                        </div>
						
						<p style="padding: 5px; color:rgba(255,0,4,1.00); margin-bottom: 5px; text-align: center;">
						Els camps amb les icones vermells <b>NO</b> son obligatoris</p>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input id="phone" name="phone" type="text" placeholder="Telèfon" class="form-control">
                            </div>
                        </div>
						 ...
						 <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input id="adjunto" name="adjunto" type="file" placeholder="Adjunta el fitxer" class="form-control">
                            </div>
                        </div>
						...
						<div class="form-group" style="margin-top: 20px;">
                            ...
                            <div class="col-lg-8">
                                <input id="phone" name="asunto" type="text" placeholder="Assumpte" class="form-control" required >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <textarea class="form-control" id="message" name="mensaje" placeholder="Introduïu el missatge aquí, em posaré en contacte amb vostè abans de dos dies hàbils." rows="7" required></textarea>
                            </div>
                        </div>
		...
		<div class="col-lg-4">
			<div class="container-fluid-info-contacto">
				...
				<i class="fas fa-location-arrow"></i>
					<h2><a href="https://goo.gl/maps/EbUoZmaLm7D8yYBH9" target="_blank">28029 Madrid (Madrid)</a></h2>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-4" style="text-align: left;">
					<nav>
						<div class="enlazes-footer"><a href="avis-legal.html">Avís Legal</a></div>
						<div class="enlazes-footer"><a href="cookies-cat.html">Política de Cookies</a></div>
						<div class="enlazes-footer"><a href="privacitat.html">Política de Privacitat</a></div>
					</nav>
				</div>
				<div class="col-lg-4">
					...
					<br/><b>Lloc creat amb molt d'</b> <i class="fas fa-heart"></i></p>
				</div>
			</div>
		</div>	
	</footer>
